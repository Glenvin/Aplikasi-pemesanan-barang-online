...
public class panelTransaksiPenjualan extends dataForAllPanel {
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {
        if (confirm("Yakin ingin mencetak \"" + txtNamaPelanggan.getText() + "\"?") == JOptionPane.YES_OPTION) {
    ...
    private void txtPotonganActionPerformed(java.awt.event.ActionEvent evt) {
        subPotongan = Integer.valueOf(txtSubTotal.getText()) * Integer.valueOf(txtPotongan.getText()) / 100;
