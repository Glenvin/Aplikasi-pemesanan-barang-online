...
public class panelBarang extends dataForAllPanel {
    ...
    private void initComponents() {
        ...
        comboBoxJenisBarang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Padat", "Cair"}));
        ...
        txtCariNamaBarang.setText("Search");
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (confirm("Yakin ingin menyimpan \"" + txtKodeBarang.getText() + "\"?") == JOptionPane.YES_OPTION) {
            ...
            databaseModel.proses(queryInsert, "dtbrg", "tambah");
            reload();
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (confirm("Apakah anda yakin ada yang ingin diubah ?\"" + txtKodeBarang.getText() + "\"?") == JOptionPane.YES_OPTION) {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (confirm("Apakah Anda sudah yakin ingin dihapus ? \"" + txtKodeBarang.getText() + "\"?") == JOptionPane.YES_OPTION) {
    ...
    private void txtCariNamaBarangKeyPressed(java.awt.event.KeyEvent evt) {
        modelBarang.setTable("SELECT * FROM DTBrg WHERE `nama_barang` LIKE '%" + txtCariNamaBarang.getText() + "%'", tabelBarang);
    }

    private void txtCariNamaBarangMouseEntered(java.awt.event.MouseEvent evt) {
        if (txtCariNamaBarang.getText().equals("cari nama barang")) {
            txtCariNamaBarang.setText("");
        }
    }

    private void txtCariNamaBarangMouseExited(java.awt.event.MouseEvent evt) {
